namespace OpenAA.Security.Checksum
{
    ...
    {
        private readonly static uint[] Crc32Table = {
        ...
        /// <summary>
        /// Get the current Crc tryGetValue.
        /// </summary>
        public long Value
        {
            get
        ...
        public void Update(int inCh)
        {
            ...
            _globalCrc = (int)((_globalCrc << 8) ^ Crc32Table[temp]);
        }
        ...
        /// </summary>
        /// <param name="array">block of data</param>
